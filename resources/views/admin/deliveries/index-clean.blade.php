        ...
        <div class="alert alert-info">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <span class="badge {{ $api_test['connection']['success'] ? 'bg-success' : 'bg-danger' }}">
                        {{ $api_test['connection']['success'] ? 'Success' : 'Failed' }}
                    </span>
                </div>
                <div class="col-md-4">
                    <strong>Authentication:</strong> 
                    <span class="badge {{ $api_test['auth']['success'] ? 'bg-success' : 'bg-danger' }}">
                        {{ $api_test['auth']['success'] ? 'Success' : 'Failed' }}
                    </span>
                </div>
                <div class="col-md-4">
                    <strong>Schedule Data:</strong> 
                    <span class="badge {{ isset($api_test['schedule']['success']) && $api_test['schedule']['success'] ? 'bg-success' : 'bg-danger' }}">
                        {{ isset($api_test['schedule']['success']) && $api_test['schedule']['success'] ? 'Success' : 'Failed' }}
                    </span>
                </div>
            </div>
        </div>
